    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-2 px-3 py-2 rounded-lg bg-background/90 backdrop-blur-sm hover:bg-background border-2 border-primary/20 hover:border-primary/40 font-bold shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
          <img
            src={user.picture}
            alt={user.name}
